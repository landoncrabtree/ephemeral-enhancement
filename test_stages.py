...
# ============================================================================
# MCRYPT PARITY TESTS (known encrypt→decrypt round-trips)
# ============================================================================

# Test vectors: ciphertext produced by libmcrypt encrypt, verified against
# known plaintext. Each tuple: (label, algo, mode, key_hex, iv_hex, plaintext_hex, ciphertext_hex)
_MCRYPT_VECTORS = [
...
class TestMcryptParity:
    ...
    def test_decrypt_matches_plaintext(
        ...
        # Compare prefix matching plaintext length; trailing bytes should be null padding
